...
## Objectif 
Tu vas y écrire un ensemble d'instruction afin de créer une image de ton application Angular. Pour cela, 2 grandes étapes : 
...
Puis lorsque tu auras mieux compris comment est organisée ton image docker : 
-  Exécute-la pour en créer un container
-  N'oublie pas de préciser le mapping de port
-  Rends-toi sur ton port mappé
-  🥳 Tadaaaaaa, ton application angular tourne 🥳
